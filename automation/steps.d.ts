...
declare namespace CodeceptJS {
  ...
  export interface I {
    ...
    debugSection(section: string, msg: string) : void,
    haveNewMailbox() : void,
    openMailbox(mailbox: string) : void,
    openEmail(email: string) : void,
    sendEmail(data: string) : void,
    waitForLatestEmail(sec: number) : void,
    waitForEmailMatching(query: string, sec: number) : void,
    waitForNthEmail(number: string, sec: number) : void,
    grabEmailsMatching(query: string, num: number) : Promise<string>,
    grabAllEmailsFromMailbox() : Promise<string>,
    seeInEmailSubject(text: string) : void,
    dontSeeInEmailSubject(text: string) : void,
    seeInEmailBody(text: string) : void,
    dontSeeInEmailBody(text: string) : void,
    seeEmailIsFrom(text: string) : void,
    seeEmailSubjectEquals(text: string) : void,
    dontSeeEmailSubjectEquals(text: string) : void,
    say: () => any; 
